...
class PickTeamViewModel(private val playerRepo: PlayerRepository, private val userRepo: UserRepository): ViewModel() {
    ...
    class Provider(private val playerRepo: PlayerRepository, private val userRepo: UserRepository): ViewModelProvider.Factory{
        override fun <T : ViewModel> create(modelClass: Class<T>): T{
            return PickTeamViewModel(playerRepo, userRepo) as T
        }
    }
}